...
const PopularCourse = () => {
  return (
    <div className="bg-zinc-100 w-full h-96">
        ...
        <div className=" ml-10 h-60 w-52 bg-white rounded-lg shadow-sm">
          <div className="">
          <div className="h-32 w-48 rounded-lg mx-2 my-2 bg-orange-500"></div>
          <div className="absolute text-[#7455F7] translate-x-32 -translate-y-12"><span className="px-1 py-1 rounded-2xl bg-white">$400</span></div>
          </div>
        ...
        <div className=" h-60 w-52 bg-white rounded-lg shadow-sm">
        <div>
          <div className="h-32 w-48 rounded-lg mx-2 my-2 bg-orange-500"></div>
          <div className="absolute text-[#7455F7] translate-x-32 -translate-y-12"><span className="px-1 py-1 rounded-2xl bg-white">$100</span></div>
          </div>
